...
FILE_PATH = r"D:\big_data\Kafka\Kafka_Assignment\restaurant_orders.csv"
...
def main(topic):
    ...
    json_serializer = JSONSerializer(schema_str, schema_registry_client, restaurent_to_dict)
    ...
    try:
        for restaurent   in get_restaurent_instance(file_path=FILE_PATH):
            ...
            producer.produce(topic=topic,
                            key=string_serializer(str(uuid4()), restaurent_to_dict),  # MUR - str(uuid4() USED FOR creting the key , you can use name as well like 'mayur' or 'xyz'
